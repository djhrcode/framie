...
export interface Container {
    get<Dependency extends ContainerToken<unknown>>(dependency: Dependency): Required<Dependency>["type"];
    register<Dependency extends ContainerToken<unknown>>(dependency: Dependency): ContainerDependency<ContainerResolver<Dependency["type"]>>;
